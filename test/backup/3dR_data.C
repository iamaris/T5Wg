...
//=========  (Tue May 27 13:16:05 2014) by ROOT version5.34/18
   TCanvas *c1 = new TCanvas("c1", "c1",11,55,700,500);
   c1->Range(-0.625,-15.67654,5.625,141.0889);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 798    ");
   text = ptstats->AddText("Mean  =  2.134");
   text = ptstats->AddText("RMS   = 0.8463");
